...
func TestTimeoutAndSSL(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			tokens: []string{
				"curl",
				"--cert", "fixtures/certs/client.crt",
				"--key", "fixtures/certs/client.key",
			...
			expected: &options.RequestOptions{
				Method:   "GET",
				URL:      "https://api.example.com/data",
				CertFile: "fixtures/certs/client.crt",
				KeyFile:  "fixtures/certs/client.key",
				CAFile:   "fixtures/certs/ca.crt",
				Headers:  http.Header{},
			},
		},
		{
			name: "Request with SSL certificate files",
			tokens: []string{
				"curl",
				"--cert", "fixtures/certs/client.crt",
				"--key", "fixtures/certs/client.key",
