// The `package gocurl_test` is defining a test suite for the `gocurl` package in
// Go. It includes test functions for various functionalities provided by the
// `gocurl` package such as creating new request options, cloning request options,
// setting basic authentication, adding headers, and setting query parameters.
// These test functions ensure that the expected behavior of the `gocurl` package
// is maintained and that the functions work as intended.
package gocurl_test
